...
- `docs/10-ui-design.md` — desktop UI design system (color tokens, layout, components, interaction principles) + Manus/Claude Cowork comparison + prioritized UI enhancement designs
