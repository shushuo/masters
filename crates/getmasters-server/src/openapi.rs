...
use getmasters_proto::{
    ...
    MemoryDto, MessageDto, PortfolioDto, PortfolioPositionDto, ProjectDto, ProviderStateDto,
    ProvidersDto, QuickChatRequest, QuoteDto, RankedMasterDto, RecipeDto, RecipeParamDto,
